    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === 'left') {
            return (
              <ChevronLeftIcon strokeWidth={2} className={cn('size-4', className)} {...props} />
            );
          }

          if (orientation === 'right') {
            return (
              <ChevronRightIcon strokeWidth={2} className={cn('size-4', className)} {...props} />
            );
          }

          return <ChevronDownIcon strokeWidth={2} className={cn('size-4', className)} {...props} />;
        },
