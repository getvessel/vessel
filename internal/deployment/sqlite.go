...
func (r *SQLiteRepository) Create(_ context.Context, d *Deployment) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) GetByID(_ context.Context, id string) (*Deployment, error) {
...
func (r *SQLiteRepository) ListByService(_ context.Context, serviceID string) ([]*Deployment, error) {
...
func (r *SQLiteRepository) Update(_ context.Context, d *Deployment) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) UpdateStatus(_ context.Context, id, status, buildLogs, containerID string) error {
	r.mu.Lock()
	defer r.mu.Unlock()
