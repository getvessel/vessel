...
func (r *SQLiteRepository) GetProvider(ctx context.Context, idOrName string) (*Provider, error) {
...
func (r *SQLiteRepository) SaveProvider(ctx context.Context, p *Provider) error {
	now := time.Now().UTC()
...
func (r *SQLiteRepository) GetUserTOTPSecret(ctx context.Context, userID string) (string, []string, error) {
	var secret string
	var recovery string
...
func (r *SQLiteRepository) UpdateUserTOTP(ctx context.Context, userID string, enabled bool, secret string, recoveryCodes []string) error {
