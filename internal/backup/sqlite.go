...
func (r *SQLiteRepository) ensureTables() error {
	queries := []string{
...
func (r *SQLiteRepository) CreateConfig(_ context.Context, cfg *BackupConfig) error {
	if cfg.ID == "" {
...
func (r *SQLiteRepository) GetConfigByID(_ context.Context, id string) (*BackupConfig, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) ListConfigsByProject(_ context.Context, projectID string) ([]*BackupConfig, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) ListAllActiveConfigs(_ context.Context) ([]*BackupConfig, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) DeleteConfig(_ context.Context, id, projectID string) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) CreateRecord(_ context.Context, rec *BackupRecord) error {
	if rec.ID == "" {
...
func (r *SQLiteRepository) ListRecordsByConfig(_ context.Context, backupConfigID string) ([]*BackupRecord, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) CreateS3Destination(_ context.Context, dest *S3Destination) error {
	if dest.ID == "" {
...
func (r *SQLiteRepository) ListS3Destinations(_ context.Context, projectID string) ([]*S3Destination, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) GetS3Destination(_ context.Context, id string) (*S3Destination, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SQLiteRepository) DeleteS3Destination(_ context.Context, id, projectID string) error {
	r.mu.Lock()
	defer r.mu.Unlock()
