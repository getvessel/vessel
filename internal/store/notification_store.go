...
func (s *Store) SaveNotificationIntegration(n *types.NotificationIntegration) error {
	...
	query := `INSERT INTO notification_integrations (
		id, smtp_enabled, smtp_host, smtp_port, smtp_user, smtp_password,
	...
	_, err := s.db.Exec(query,
		n.ID, n.SMTPEnabled, n.SMTPHost, n.SMTPPort, n.SMTPUser, n.SMTPPassword,
