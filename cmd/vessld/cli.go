...
func printHelp() {
	...
	fmt.Printf("Deployment commands:\n")
	fmt.Printf("  deploy <url>                       Deploy from Git URL\n")
	fmt.Printf("  deploy --image <img> --port <n>    Deploy Docker image\n")
	fmt.Printf("  deploy --compose <file>            Deploy docker-compose\n\n")
