...
When a pull request is opened against your connected repository, Vessl can spin up an ephemeral preview environment. The webhook triggers a new deployment on the PR branch, and a comment is added to the PR with the preview URL.
